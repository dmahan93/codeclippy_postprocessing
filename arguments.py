# Original file from https://github.com/huggingface/transformers/blob/main/examples/research_projects/codeparrot/scripts/arguments.py
...
class PreprocessingArguments:
    ...
    bucket_name: str = field(
        metadata={"help": "s3 bucket to grab"}
    )
